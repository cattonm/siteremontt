...
export const ROOM_QUESTIONS_CONFIG = {
    room: [
        { id: "floor", text: "Тип підлоги.", type: "cards", options: [
        ...
        { id: "walls", text: "Стіни.", type: "cards_multiselect", options: [
        ...
        { id: "light", text: "Освітлення.", type: "cards_multiselect", options: [
        ...
        { id: "sills", text: "Підвіконня.", type: "cards", options: [
        ...
        { id: "decor", text: "Декор.", type: "cards", options: [
        ...
        { id: "other", text: "Інші потреби", type: "multiselect_complex", hasOther:false, options: [
            {label:"Радіатор",tier:true}, {label:"Кондиціонер", tier:true}, {label:"Звукоізоляція", tier:false}
        ]}
    ],
    bath: [
        { id: "floor", text: "Плитка на підлогу (формат)", type: "cards", options: [
        ...
        { id: "wall_tile", text: "Плитка на стіни (формат)", type: "cards", options: [
            { label: "Мозаїка", val: "Мозаїка" }, { label: "Плитка до 120*60", val: "Керамограніт/Плитка до 120*60" }, { label: "Великоформатний", val: "Великоформатний керамограніт" }
        ]},
        { id: "shower", text: "Душ.", type: "cards_multiselect", options: [
        ...
        { id: "tub", text: "Ванна", type: "cards_with_tier", options: [
        ...
        { id: "toilet", text: "Унітаз.", type: "cards_with_tier", options: [
        ...
        { id: "mixer_std", text: "Кількість звичайних змішувачів (шт)", type: "input_number", placeholder: "0" },
        { id: "mixer_hidden", text: "Змішувачі прихованого монтажу (шт)", type: "input_number", placeholder: "0" },
        { id: "other", text: "Інші потреби", type: "multiselect_complex", hasOther:false, options: [
    ...
    kitchen: [
        ...
        { id: "floor", text: "Підлога.", type: "cards", options: [
        ...
        { id: "apron", text: "Фартух.", type: "cards", options: [
    ...
    balcony: [
        ...
        { id: "other", text: "Облаштування балкону", type: "multiselect_complex", hasOther: false, options: [
    ...
    basement: [
        ...
        { id: "ceiling", text: "Тип стелі.", type: "cards", options: [
